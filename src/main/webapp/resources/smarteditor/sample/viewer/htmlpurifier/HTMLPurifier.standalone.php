...
class HTMLPurifier_ContentSets
{
    ...
    /**
     * List of cb_content set strings (pipe separators) indexed by name.
     * @type array
     */
    public $info = array();

    /**
     * List of cb_content set lookups (element => true) indexed by name.
     * @type array
    ...
    /**
     * Synchronized list of defined cb_content sets (keys of info).
     * @type array
     */
    protected $keys = array();
    /**
     * Synchronized list of defined cb_content values (values of info).
     * @type array
     */
    protected $values = array();

    /**
     * Merges in module's cb_content sets, expands identifiers in the cb_content
        ...
        foreach ($modules as $module) {
            foreach ($module->content_sets as $key => $value) {
                ...
                if (isset($this->lookup[$key])) {
                    // add it into the existing cb_content set
     ...
     *       subclasses that need cb_content set expansion
...
class HTMLPurifier_ElementDef
{
    ...
    /**
     * Does the element have a cb_content model (#PCDATA | Inline)*? This
...
class HTMLPurifier_HTMLDefinition extends HTMLPurifier_Definition
{
    ...
    /**
     * Nested lookup array of cb_content set name (Block, Inline) to
     * element name to whether or not it belongs in that cb_content set.
     * @type array
     */
...
class HTMLPurifier_HTMLModule
{
    ...
    /**
     * Associative array of cb_content set names to cb_content set additions.
     * This is commonly used to, say, add an A element to the Inline
     * cb_content set. This corresponds to an internal variable $content_sets
     ...
     * @param string|bool $type What cb_content set should element be registered to?
    ...
    public function addElement($element, $type, $contents, $attr_includes = array(), $attr = array())
    {
        ...
        // add element to cb_content sets
        if ($type) {
    ...
    /**
     * Convenience function that registers an element to a cb_content set
     * @param string $element Element to register
     * @param string $type Name cb_content set (warning: case sensitive, usually upper-case
     *        first letter)
     */
     ...
     * into separate cb_content model and cb_content model type
     * @param string $contents Allowed children in form of:
     *                  "$content_model_type: $content_model"
     * @return array
    ...
    public function parseContents($contents)
    {
        ...
        switch ($contents) {
            // check for shorthand cb_content model forms
            case 'Empty':
                return array('empty', '');
            case 'Inline':
...
class HTMLPurifier_HTMLModuleManager
{
    ...
    public function setup($config)
    {
        ...
        $this->contentSets = new HTMLPurifier_ContentSets(
            // cb_content set assembly deals with all possible modules,
...
class HTMLPurifier_Lexer
{
    ...
    /**
     * Takes a string of HTML (fragment or document) and returns the cb_content
     * @todo Consider making protected
     */
...
class HTMLPurifier_AttrDef_CSS_FontFamily extends HTMLPurifier_AttrDef
{
    ...
    public function validate($string, $config, $context)
    {
        ...
        foreach ($fonts as $font) {
            ...
            //    fact, in IE8, the 'cb_content' CSS property gained
...
class HTMLPurifier_ChildDef_Table extends HTMLPurifier_ChildDef
{
    ...
    public function validateChildren($children, $config, $context)
    {
        ...
        foreach ($children as $node) {
            ...
            case 'thead':
                ...
                if ($thead === false) {
                    ...
                    // tbody tags, and then put into cb_content.
        ...
        if ($tbody_mode) {
            ...
            $ret = array_merge($ret, $cb_content);
        }
 ...
 * declare directionality of cb_content. Text Extension Module.
 */
...
class HTMLPurifier_HTMLModule_Forms extends HTMLPurifier_HTMLModule
{
    ...
    public function setup($config)
    {
        ...
        // For exclusions, ideally we'd specify cb_content sets, not literal elements
...
class HTMLPurifier_HTMLModule_List extends HTMLPurifier_HTMLModule
{
    ...
    // According to the abstract schema, the List cb_content set is a fully formed
...
class HTMLPurifier_Lexer_DOMLex extends HTMLPurifier_Lexer
{
    ...
    protected function wrapHTML($html, $config, $context)
    {
        ...
        $ret .= '<html><head>';
        $ret .= '<meta http-equiv="Content-Type" cb_content="text/html; charset=utf-8" />';
...
class HTMLPurifier_URIScheme_data extends HTMLPurifier_URIScheme
{
    ...
    public function doValidate(&$uri, $config, $context)
    {
        ...
        // for filtering arbitrary cb_content types
        ...
        if ($real_content_type != $content_type) {
            // we're nice guys; if the cb_content type is something else we
