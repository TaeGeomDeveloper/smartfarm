...
public class NaverSensV2 {
    ...
    public void sendSMS(String tel, String rand) {
        ...
        bodyJson.put("from","01064195197");

        bodyJson.put("content","qualified number is  ["+rand+"]");		// 난수와 함께 전송
...
//        bodyJson.put("from","01064195197");	// 발신번호 * 사전에 인증/등록된 번호만 사용할 수 있습니다.
//        bodyJson.put("messages", toArr);
